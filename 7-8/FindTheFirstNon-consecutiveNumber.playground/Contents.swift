...
/*
 Find the first non-consecutive number. Swift.
 ...
 1 Can you write a solution that will return null2 for both [] and [ x ] though? (This is an empty array and one with a single
